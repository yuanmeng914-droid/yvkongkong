const CACHE_NAME = "mingri-shell-4.2";
const APP_SHELL = ["./", "./index.html", "./styles.css?v=3.1.0", "./app.js?v=3.0.1", "./task-sync.mjs?v=1.0.0", "./config.js?v=4.0.0", "./manifest.webmanifest", "./icon.svg", "./offline.html"];
