const CACHE_NAME = "mingri-shell-4.3";
const APP_SHELL = ["./", "./index.html", "./styles.css?v=3.2.0", "./app.js?v=3.0.2", "./task-sync.mjs?v=1.0.0", "./config.js?v=4.0.0", "./manifest.webmanifest", "./icon.svg", "./offline.html"];
